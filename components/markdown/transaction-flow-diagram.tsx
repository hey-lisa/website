...
export default function TransactionFlowDiagram() {
  ...
  const getUserStage = useCallback((): string => {
    switch (animationStep) {
      case 0:
      case 1: return '💬 CHATS WITH\nLISA';
      case 8: return '👁️ EXAMINES\nTXS';
      case 9: return '✍️ SIGNS\nTXS';
      case 10: return '📡 TX\nCONFIRMED';
      default: return 'USER';
    }
  }, [animationStep]);
  ...
  const getLisaStage = useCallback((): string => {
    switch (animationStep) {
      case 2: return '🔍 VERIFICATIONS\n& CONTEXT';
      case 3: return '🧠 PARSING\nINTENT';
      case 4: return '⚙️ CRAFTING\nTX';
      case 5: return '⚙️ CRAFTING\nTX';
      case 6: return '⚙️ CRAFTING\nTX';
      case 7: return '✅ TX READY';
      default: return '🤖 LISA';
    }
  }, [animationStep]);
