  ...
  return (
    <div className="grid grid-cols-2 flex-grow sm:py-10 sm:py-7 py-4 pt-5 gap-5">
      <div>
        {res.prev && (
          <Link
            className="lisa-link no-underline w-full flex flex-col sm:pl-7 pl-3 sm:py-10 py-8 !items-start text-xs sm:text-sm"
      ...
      <div>
        {res.next && (
          <Link
            className="lisa-link no-underline w-full flex flex-col sm:pr-7 pr-3 sm:py-10 py-8 !items-end text-xs sm:text-sm"
